<template>
  <div id="Bclass">
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" size="small " @click="showSouSuo" icon="el-icon-search">搜 索</el-button>
        <el-button @click="showChongZhi" size="small " icon="el-icon-refresh">重 置</el-button>
      </el-form-item>
    </el-form>
    <el-row>
      <el-col>
